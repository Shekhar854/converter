                    ...
                    <div className="flex flex-col mt-2">
                        <div className="flex items-center gap-5  justify-center">
                            ...
                            <div className="target">
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{1 * rates[targetCurrency].toFixed(2)}</p>
                ...
                <div className="border mt-5 p-5 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] w-96 rounded-xl">
                    ...
                    <div className="flex flex-col mt-2">
                        <div className="flex items-center gap-5  justify-center">
                            ...
                            <div className="target">
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{Number((1 / rates[targetCurrency]).toFixed(5))}</p>
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{Number((5 / rates[targetCurrency]).toFixed(5))}</p>
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{Number((10 / rates[targetCurrency]).toFixed(5))}</p>
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{Number((25 / rates[targetCurrency]).toFixed(5))}</p>
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{Number((50 / rates[targetCurrency]).toFixed(5))}</p>
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{Number((100 / rates[targetCurrency]).toFixed(5))}</p>
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{Number((500 / rates[targetCurrency]).toFixed(5))}</p>
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{Number((1000 / rates[targetCurrency]).toFixed(5))}</p>
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{Number((5000 / rates[targetCurrency]).toFixed(5))}</p>
                                <p className="text-xl font-medium flex items-center"> <FaArrowRightLong />&nbsp; &nbsp;{Number((10000 / rates[targetCurrency]).toFixed(5))}</p>
